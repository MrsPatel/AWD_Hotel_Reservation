  ...
  render() {
    return (
        <nav className="">
            ...
            <i class="fa fa-envelope w3-text-red"> </i> Email: email@email.com<br></br>
            <form action="" target="_blank">
                <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Name" required name="Name"></input></p>
                <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Email" required name ="Email"></input></p>
